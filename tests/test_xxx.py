...
class TestResult:
    ...
    def test_pizza_1(self, set_up_browser):
        ...
        with allure.step('Кладём два товара в корзину'):
            el_1 = driver.find_element(By.XPATH, '(//img[@src="http://pizzeria.skillbox.cc/wp-content/uploads/2021/10/pexels-natasha-filippovskaya-4394612-300x300.jpg"])[1]')
            el_2 = driver.find_element(By.XPATH, "(//*[@class='button product_type_simple add_to_cart_button ajax_add_to_cart'])[5]")
            el_3 = driver.find_element(By.XPATH,"(//img[@src='http://pizzeria.skillbox.cc/wp-content/uploads/2021/10/pexels-katerina-holmes-5908222-300x300.jpg'])[2]")
            el_4 = driver.find_element(By.XPATH,"(//*[@class='button product_type_simple add_to_cart_button ajax_add_to_cart'])[6]")
    ...
    def test_pizza_4(self, set_up_browser):
        ...
        with allure.step('Перешли на страницу Корзина'):
            wait = WebDriverWait(driver, 10)
            wait.until(EC.visibility_of_element_located((By.XPATH, "//i[@class='fa fa-shopping-cart']")))
    ...
    def test_pizza_6(self, set_up_browser):
        ...
        with allure.step('В фильтре по цене установили 130руб.'):
            el = driver.find_element(By.XPATH, "(//span[@class='ui-slider-handle ui-state-default ui-corner-all'])[2]")
            actions = ActionChains(driver)
    ...
    def test_pizza_7(self, set_up_browser):
        ...
        with allure.step('Клик на кнопку Регистрация'):
            driver.find_element(By.CSS_SELECTOR, "button[class='custom-register-button']").click()
...
class TestAddition:
    ...
    def test_pizza_12(self, set_up_browser):
        ...
        with allure.step('Переходим на главную страницу'):
            driver.find_element(By.LINK_TEXT, 'Главная').click()
        with allure.step('Кладём товар в корзину из карусели'):
            el_1 = driver.find_element(By.XPATH,"(//img[@src='http://pizzeria.skillbox.cc/wp-content/uploads/2021/10/pexels-katerina-holmes-5908222-300x300.jpg'])[2]")
            el_2 = driver.find_element(By.XPATH,"(//*[@class='button product_type_simple add_to_cart_button ajax_add_to_cart'])[6]")
            actions = ActionChains(driver)
            actions.move_to_element(el_1).pause(2)
            actions.click(el_2).pause(2)
            actions.perform()
...
class TestAdditionPlaywright:
    ...
    def test_cupon(self, browser):
        ...
        with allure.step('Открываем карточку товара'):
            page.goto('https://pizzeria.skillbox.cc/product/%d0%bf%d0%b8%d1%86%d1%86%d0%b0-4-%d0%b2-1/')
